...
@Component({
  ...
  styles: [`
    ...
    .skel-header .skel-cell { height: 12px; background: #EDF0F5; }
    .skel-cell {
      flex: 1; height: 16px; border-radius: 6px;
      background: linear-gradient(90deg, #EDF0F5 25%, #F5F7FA 50%, #EDF0F5 75%);
    ...
    .skel-card {
      ...
      border-radius: 12px; border: 1px solid #EDF0F5;
